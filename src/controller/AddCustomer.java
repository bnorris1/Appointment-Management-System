...
public class AddCustomer implements Initializable {
    ...
    @FXML private void onActionSaveCust(ActionEvent event) throws IOException {
        ...
        if (custType.getSelectionModel().isEmpty()){Shared.errorManager("c7");}
            ...
            int cID = JDBQueries.getNextAvailCustId();
            ...
            if (cType.equals("Distributor")) {
                ...
                JDBQueries.addCustomer((Distributor) customer);
            } else {
                ...
                JDBQueries.addCustomer((Individual) customer);
            }
